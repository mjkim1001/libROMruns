...
continue
	#q=$((${n_nl[$n]}*2))
srun -n 1 -p pdebug mixed_nonlinear_diffusion -online -rrdim ${n_r[$n]} -rwdim ${n_w[$n]} -nldim ${n_nl[$n]} -p 1  -nsr $q -sopt > "${myPath}/mnd_rep_sopt_online${n}q${q}.txt"
...
srun -n 1 -p pdebug mixed_nonlinear_diffusion -online -rrdim ${n_r[$n]} -rwdim ${n_w[$n]} -nldim ${n_nl[$n]} -p 1  -nsr $q > "${myPath}/mnd_rep_pod_online${n}q${q}.txt"
...
srun -n 1 -p pdebug mixed_nonlinear_diffusion -online -rrdim ${n_r[$n]} -rwdim ${n_w[$n]} -nldim ${n_nl[$n]} -p 1  -nsr $q -qdeim > "${myPath}/mnd_rep_qdeim_online${n}q${q}.txt"
