...
output="${myPath}/sbCLSserial${t}.txt"
printf "method,t,n,xx,vv,ee,q,condV,condE,time,ErrX,ErrV,ErrE\n"  > "$output"
...
echo $cond
printf "clssopt,${t},${n},${ndim[0]},${ndim[1]},${ndim[2]},${q},${cond},${TT},${errX},${errV},${errE}\n" >> "$output"
rm -r run/sbShortSerial
rsync -a run/sbShort/. run/sbShortSerial/
...
printf "clsqdeim,${t},${n},${ndim[0]},${ndim[1]},${ndim[2]},${q},${cond},${TT},${errX},${errV},${errE}\n" >> "$output"
rm -r run/sbShortSerial
rsync -a run/sbShort/. run/sbShortSerial/
printf "cls q${q}gnat" 
...
printf "clsgnat,${t},${n},${ndim[0]},${ndim[1]},${ndim[2]},${q},${cond},${TT},${errX},${errV},${errE}\n" >> "$output"
...
printf "sopt,${t},${n},${ndim[0]},${ndim[1]},${ndim[2]},${q},${cond},${TT},${errX},${errV},${errE}\n" >> "$output"
rm -r run/sbShortSerial
rsync -a run/sbShort/. run/sbShortSerial/
printf "q${q}qdeim"
...
printf "qdeim,${t},${n},${ndim[0]},${ndim[1]},${ndim[2]},${q},${cond},${TT},${errX},${errV},${errE}\n" >> "$output"
...
printf "gnat,${t},${n},${ndim[0]},${ndim[1]},${ndim[2]},${q},${cond},${TT},${errX},${errV},${errE}\n" >> "$output"
