...
printf "method,rs,window,t,ws,w,q,nqp,TT1,TT2,TT3,TT4,ErrX,ErrV,ErrE\n"  > "$output"
...
printf "sopt,${t},${ws},${w},${q},${nqp}${TT1},${TT2}${TT3},${TT4},${errX},${errV},${errE}\n" >> "$output"
...
printf "qdeim,${t},${ws},${w},${q},${nqp}${TT1},${TT2}${TT3},${TT4},${errX},${errV},${errE}\n" >> "$output"
...
printf "gnat,${t},${ws},${w},${q},${nqp}${TT1},${TT2}${TT3},${TT4},${errX},${errV},${errE}\n" >> "$output"
done
done
done
done
